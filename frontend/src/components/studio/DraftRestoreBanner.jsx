...
export default function DraftRestoreBanner({ draftTime, onRestore, onDismiss }) {
  return (
    <div className="flex shrink-0 items-center justify-between gap-3 border-b border-amber-200/80 bg-amber-50 px-4 py-2.5 text-sm dark:border-amber-900/50 dark:bg-amber-950/40">
